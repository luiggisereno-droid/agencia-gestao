...
{tab === "checklist" && (
          <div>
            ...
            {[{ field: "produtosBanidos", label: " Produtos Banidos", ph: "Ex: 3 produtos banidos." },{ field: "estoque", label: " Estoque de Produtos", ph: "Ex: 12 produtos críticos." },{ field: "ads", label: " ADS", ph: "Ex: Campanhas ativas: 5." },{ field: "pesos", label: " Pesos dos Produtos", ph: "Ex: Corrigido peso de 8 produtos." }].map(({ field, label, ph }) => (
        ...
        {tab === "ads" && (
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
              {[{ field: "roas", label: " ROAS", ph: "Ex: 4.2" },{ field: "impressoes", label: " Impressões", ph: "Ex: 128.400" },{ field: "cliques", label: " Cliques", ph: "Ex: 3.210" },{ field: "investimento", label: " Investimento (R$)", ph: "Ex: 1.250,00" },{ field: "ctr", label: " CTR (%)", ph: "Ex: 2,5%" }].map(({ field, label, ph }) => (
...
{tab === "duvidas" && (
          <div>
            ...
            <div style={{ ...cardStyle, borderTop: "3px solid #6366f1", marginBottom: 24 }}>
              <div style={{ fontWeight: 700, fontSize: 14, color: "#a5b4fc", marginBottom: 16 }}> Nova dúvida</div>
